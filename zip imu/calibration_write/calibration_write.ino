...
void setup() {
  ...
  // in uTesla
  cal.mag_hardiron[0] = -36.44;
  cal.mag_hardiron[1] = -56.55;
  cal.mag_hardiron[2] = 3.57;

  // in uTesla
  cal.mag_softiron[0] = 0.995;
  cal.mag_softiron[1] = 0.002;
  cal.mag_softiron[2] = 0.031;  
  cal.mag_softiron[3] = 0.002;
  cal.mag_softiron[4] = 0.986;
  cal.mag_softiron[5] = -0.008;  
  cal.mag_softiron[6] = 0.0031;
  cal.mag_softiron[7] = -0.008;
  cal.mag_softiron[8] = 1.021;
  ...
  cal.mag_field = 35.88; // approximate value for locations along the equator
